...
gantt
    ...
    section 방향·전략
    사업방향·포지셔닝           :d0, 2026-07-01, 3w
    가격·BM·정산 설계          :d1, after m1, 2w

    section 강사 구인
    강사 수요·단가 파악(검증)    :m1, after d0, 3w

    section 공간 기획
    평수·조닝·도구 기준         :g1, after d0, 3w

    section 브랜드
    네이밍·컬러·로고            :b1, after d0, 8w
...
| 웨이브 | 시점 | 동시 착수 | 이유 |
|---|---|---|---|
| **0. 지금** | M1 | ★ **법인·지분 구조** · **사업방향·포지셔닝** · **API 인프라 복구** | 법인은 출자·계약·상표·임대의 주체(절대 1번). 포지셔닝=사업 방향이라 여기서. API 복구는 코드 독립 → 지금 바로 |
| **1. 방향 확정 직후** | M1~ | **브랜드(네이밍·로고) ∥ 매물 조사** (각 2~3개월) · 강사 수요·단가 **파악(검증)** · 공간 기획 · **가격·BM·정산 설계** | 브랜딩·매물이 **제일 길어** lead time 확보 위해 동시 착수. 가격·BM은 강사 단가 나오면 확정(서비스 가격입력 입력값) |
