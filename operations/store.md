...
**🟢 확정 (2026-05-16)** · 의존: [6B 가맹점주 R&R](../expansion/responsibility.html), [4D 공간](../service/space.html), [ADR 0002](../decisions/0002-license-policy.html), [5D 자유 헬스](./free-gym.html)
...
- **하이브리드 시간**: 10:00 – 17:00 (강사 세션 중심, 가맹점장 대기 가능)
...
| 강사 (Pro / 일반) | 프로그램 매핑 | 시간 단위 셰어 | partners/peer-leader.md |
...
1. **회원 앱 QR 체크인** (기본 경로)
   - 게이트 QR 스캐너 → `Reservation` 확인 → 입장 허용 → `enterAt` 기록
...
4. 입장 실패 시 (회차 0, 만료 grace 초과) → CS 응대 + 회차권 구매 유도
...
- 가맹점장: 일상 운영 · 시설 점검 · 사고 1차 대응 · 강사 일정 조율
