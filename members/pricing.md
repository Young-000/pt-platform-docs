...
## Pro 옵션 포인트 충전 정책 (2026-05-16 결정)

> **결정**: 충전 단위 **10,000원** (회당 차감 5,000원의 자연 배수). 1회 충전 시 **최소 10,000원, 최대 300,000원**.

### 규칙

- **충전 단위**: 10,000원 (1만·2만·5만·10만·20만·30만 등)
- **차감 단위**: 회당 5,000원 (Pro 강사 선택 시 자동 차감)
- **유효 기간**: 멤버십 만료 시점까지 (만료 30일 grace 동안 사용 가능)
- **환불 룰**: **미사용 포인트 현금 결제분 = 100% 현금 환불**. 보너스 포인트(이벤트·프로모션) = 환불 ❌. 환불 룰은 `admin.point_bonus_refundable` 토글로 조정 가능.
- **자동 충전 옵션**: 잔액 5,000원 미만 시 자동 충전 (회원 설정).

### 근거

- 5,000원 단위 회당 차감과 10,000원 충전이 자연스러운 배수 (잔액 분수화 ❌)
- 최소 10,000원 → 2회 분 보장 (체험 마찰 최소)
- 최대 300,000원 → 60회 분 (48회 대형 회차권 + 여유) — 과충전 회피
