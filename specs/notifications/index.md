...
> **GX 영향 (2026-06-03)**: GX 전환 후 알림 트리거 주체가 변경됨. 핵심 추가: 충전 완료·예약 확정·취소 환불·클래스 완료·폐강 전원 환불. PT 레일 알림(매칭·Pro swap 등)은 미활성. 채널·데이터 모델은 재사용 가능 ([ADR 0011](../../decisions/0011-recovergx-gx-pivot.html)).
...
| 2026-06-03 | GX 영향 배너 추가 — 트리거 주체 변경, PT 알림 미활성 (ADR 0011) |
