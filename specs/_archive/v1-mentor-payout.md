...
{: .warning }
> **v2 변경 ([ADR 0001](../../decisions/0001-consumer-pivot.html))**: 단가 = **S1 파트타이머 12,000원/30분** ~ **S2 전문 강사 최대 20,000원/30분 상한**. Pro 인증 옵션 = 회당 +5,000원 (회원 추가금, 강사 인센티브). 90분 세트 분배 가설은 폐기. 본문은 v1 기준이며 정산 모듈 재설계 시 v2로 갱신 필요.
